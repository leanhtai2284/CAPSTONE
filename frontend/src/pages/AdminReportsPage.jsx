...
const AdminReportsPage = () => {
  ...
  const userRegistrationByMonthData = fillMonthlyTrend(trends.userRegistrationByMonth, 12);
  const recipeCreationByMonthData = fillMonthlyTrend(trends.recipeCreationByMonth, 12);
      ...
      <div className="flex-1 ml-64">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Tổng số công thức</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-white mt-2">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Người dùng mới (30 ngày)</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-white mt-2">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Công thức mới (30 ngày)</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-white mt-2">
