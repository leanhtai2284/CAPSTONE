        ...
        >
          ...
          >
            ...
            >
              {/* Pot Body */}
              <motion.path
                d="M 70 120 L 70 160 Q 70 180 90 185 L 160 185 Q 180 180 180 160 L 180 120 Z"
                fill="#4B5563"
                stroke="#374151"
                strokeWidth="3"
              ...
              >
                <ellipse
                  ...
                  strokeWidth="3"
                />
                <circle cx="125" cy="95" r="8" fill="#374151" />
              </motion.g>
              ...
              {[0, 1, 2, 3, 4].map((i) => (
                <motion.circle
                  key={i}
                  cx={80 + Math.cos((i * 72 * Math.PI) / 180) * 70}
                  cy={140 + Math.sin((i * 72 * Math.PI) / 180) * 70}
                  r="3"
                  fill="#22C55E"
              ...
              >
                <motion.path
                  d="M 190 140 L 200 120 L 210 140 L 200 135 Z"
                  fill="#22C55E"
                  animate={{ y: [0, -5, 0] }}
